...
- Nutzung als Informations- und Beschaffungsquelle (E-Procurement)
- E-Mail-Kommunikation mit Kunden und Lieferanten
- Gewinnung von Mitarbeitern
- Teilnahme an öffentlichen Ausschreibungen
- Nutzung von Social Media (Facebook, Instagram, LinkedIn, Xing etc.)
...
3. **Zuständigkeiten** festlegen: Wer ist für Aufbau, Texte, Grafik, Technik und Pflege verantwortlich?
4. **Internetauftritt bewerben:** z. B. über Visitenkarten, Geschäftspapier, E-Mail-Signatur, Suchmaschinen
...
- Zielgruppenorientierte URL-Texte
- Zielgruppenorientierte Inhalte
- Keyword-Optimierung (Schlüsselwörter)
...
Qualitätsmanagement (QM) bezeichnet die Gesamtheit aller qualitätsbezogenen Tätigkeiten und Zielsetzungen, bei der strukturelle, organisatorische und wirtschaftliche Maßnahmen aufeinander abgestimmt eingesetzt werden. Es ist ein Mittel zur optimalen Unternehmensführung.
...
3. Analyse bereits vorhandener Qualitätssicherungsmaßnahmen
4. Angleichung vorhandener Elemente und Ergänzung durch neue Maßnahmen
...
- Zukunftssicherung des Unternehmens durch dauerhaften Verbesserungsprozess

---

> [!NOTE]
> **Ergänzung:** Das EMAS (Eco-Management-Audit-Scheme) ist ein Umwelt-Management-System auf betrieblicher Ebene für Klimaschutz, Nachhaltigkeit und Ressourcenschonung.
...
- Einhaltung aktueller Vorschriften gewährleisten
- Nebenleistungen im Preis einschließen, Alternativen anbieten
- Referenzen nennen, Liefer- und Ausführungszeit angeben
...
- Bezug zum Auftrag
- Bezeichnung „Rechnung" in der Betreffzeile
- Gegenstand der Leistung / Lieferung
- Zeitpunkt der Lieferung oder Leistung
- Entgelt aufgeschlüsselt nach Mehrwertsteuersätzen
- Nettobetrag in Euro
- Mehrwertsteuerbetrag und Bruttobetrag

---

> [!IMPORTANT]
> **Wichtig:** Die Rechnung sollte zeitnah nach Abschluss des Auftrags gestellt werden und einen Zahlungstermin enthalten. Vor Abschluss sollten möglichst genaue Abschlagsrechnungen gestellt werden.
...
| ------------------------------- | ---------------------------------------------------------- |
| **Bilanzrechnung**              | Jahresabschluss (Bilanz + GuV); erfolgszielorientiert      |
| **Kosten- und Erlösrechnung**   | Internes Rechnungswesen; Kalkulation &amp; Kostenkontrolle |
| **Finanzrechnung**              | Liquiditätssicherung; Ein- und Auszahlungen                |
| **Sozial- / Potenzialrechnung** | Humanvermögen, soziales Engagement, Umweltbilanzen         |

---

> [!IMPORTANT]
> **Merke:** Finanz-, Bilanz- sowie Kosten- und Erlösrechnung sind die **Kernsysteme** des traditionellen Rechnungswesens.
...
Vor Betriebsbeginn sind einzurichten:

1. Ordnungsgemäße **Buchführung**
2. Sachgerechte **Kostenrechnung und Kalkulation**
3. Funktionsfähiges **Controlling**

---

> [!TIP]
> Tipp: Einbeziehung eines **Steuerberaters** ist empfehlenswert.
...
- **Buchstellen** (z. B. organisationseigene Einrichtungen)
- **Steuerkanzleien**
...
> [!IMPORTANT]
> **Definition:** Unter zwischenbetrieblicher Kooperation versteht man die freiwillige Zusammenarbeit zwischen rechtlich selbstständigen Unternehmen. Die wirtschaftliche Entscheidungsfreiheit der einzelnen Betriebe bleibt dabei weitgehend erhalten.
...
- Leistungssteigerung und Verbesserung der Leistungschancen
...
**Leistungserstellung:** Subunternehmer, Arbeitsgemeinschaften, Leistungsgemeinschaften, Zulieferverträge, Handwerkerhöfe, Gewerbeparks, Gründerzentren

**Vertrieb:** Gemeinsame Vermarktung, Verbundwerbung, Sammelwerbung

**Verwaltung:** Finanzierung, Personalplanung, Rechnungswesen, IT, Erfahrungsaustausch

**Facility Management:** Kooperation von Elektro-, Sanitär-, Heizungs-, Klima- und Reinigungsbetrieben für Gebäudemanagement „aus einer Hand"
...
- Aufgabenbeschreibung und Leistungsumfang
- Pflichten der Kooperationspartner
- Rechtsbeziehungen untereinander und gegenüber Dritten
- Beginn, Dauer, Kündigungsregelungen
...
> [!IMPORTANT]
> **Rechtlicher Rahmen:** Kooperationen sind nach dem Gesetz gegen Wettbewerbsbeschränkungen (GWB) ausdrücklich erlaubt, sofern sie sich nicht auf reine Preisabsprachen beziehen.
